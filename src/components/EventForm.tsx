    ...
    return (
        <>
            ...
            <FormControlLabel
                control={
                    <Checkbox
                        disabled={!data.group?.canAddSinger}
                        style={{ color: theme.palette.primary.main }}
                        checked={data.withSinger}
                        onChange={(e) => {
                            onChange({ ...data, withSinger: e.target.checked });
                        }}
                    />
                }
                label="Añadir Cantante"
